...
def homepage(request):
    return render(request=request,template_name='main/home.html',context={'tutorial':Tutorial.objects.all(), 'categories':TutorialCategory.objects.all(),'series':TutorialSeries.objects.all()})
